        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            ?>
                <tr>
                    ...
                    <th>
                        <span class="glyphicon glyphicon-cloud-download" onclick="getActive(<?php echo $row['ID_Ebook']?>)"></span> 
                    </th>
                </tr>
            <?php 
                } 
...
<script type="text/javascript">
            ...
            function getActive(id) {
                ...
                if ($row['Active'] == 1) {
                    alert("Ebook Sudah Bisa Di Dwonload");
                }
            }
</script>